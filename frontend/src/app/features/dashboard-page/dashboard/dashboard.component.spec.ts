...
describe('DashboardComponent - Pure unit testing (No Mocks)', () => {
  ...
  describe('filterUserGames() - Filtering logic', () => {
    beforeEach(() => {
      // Set sortedGames directly on the component
    ...
    it('should filter games by user played games', () => {
      component.userGames = [
    ...
    it('should handle GAME# prefix removal from PK', () => {
    ...
    it('should handle situation when game is not found in sortedGames', () => {
      component.userGames = [
  ...
  describe('Sorting logic - Pure Function Testing', () => {
